module github.com/ManyakRus/whatsapp_chatgpt
...
require (
	github.com/ManyakRus/starter v1.0.49
...
require (
	...
	github.com/rugatling/go-openai v0.0.0-20240619084423-aeaffca189bb // indirect
